...
<p>The answer is easy, JS <q>behind the scenes</q> changes the string primitive into string object, on the string object calls the method and returns to its orginal form. Let's unmask the JS!</p>
...
```
<p>There are also two such a primitive object wrappers, one for Number and one for Boolien, the principle of how they work is the same as a string wrapper.</p>